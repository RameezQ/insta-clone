...
const TeacherProfile = (props) => {
    const initialState = {
        name: "", fatherName: "", cell: "", teacherId: "", address: "", photo: "", classOfTeach: "", education: "m",
        subject: "", salary: "", reference: "", idCard: ""
    }
    ...
    function handleSubmit(event) {
        ...
        async function postArticle() {
            ...
            try {
                const response = await axios.put(`/teacher/${id}`, article, {
                    headers: {
                        "Content-Type": "application/json",
                        "Authorization": "Bearer " + localStorage.getItem("jwt")
                    }
                });
                toast.success('Teacher Recored update sccuessfully!', {
                    position: "top-right",
                    autoClose: 5000,
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <div className="card card-profile">
                            ...
                            <div className="card-body">
                                <h6 className="card-category">{article.teacherId}</h6>
                                <h4 className="card-title">{article.name}</h4>
                                <p className="card-description">
                                    Don't be scared of the truth because we need to restart the human foundation in truth And I love you like Kanye loves Kanye I love Rick Owens’ bed design but the back is...
                  </p>
                                <Link to="#pablo" className="btn btn-primary btn-round">Follow</Link>
                            </div>
                        </div>
                    </div>
                </div>
